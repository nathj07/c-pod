# iParadigms - include this as couldn't find an appropriate git package for CentOS6
# Modified with release suffix .ip for use in lifted repo. Otherwise vanilla based
# on http://download.fedoraproject.org/pub/epel/5/SRPMS/git-1.8.2.1-1.el5.src.rpm
